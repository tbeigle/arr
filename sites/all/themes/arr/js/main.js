(function($) {
  Drupal.behaviors.arr = {
    attach: function(context, settings) {
        ...
        if (slide_count > 0) {
          ...
          $('.field-name-field-slides').animate({opacity: 1}, slides_fade_time, function() {
            if (slide_count > 1 && (user_is_admin || show_ss_for_all)) {
              ...
              $('.' + slide_arrows.both).fadeIn(slides_fade_time).click(function() {
                toggle_slides($(this));
       ...
       * Forms
       */
      $('#webform-client-form-12 #edit-submitted-are-you-a-vendor-representative-1').change(function() {
      ...
      $('#edit-submitted-vendor').change(function() {
        var $this = $(this)
            vendor_val = $this.val(),
      ...
      $('#js-more-vendors').click(function() {
